...
<main id="main" class="site-main">
    ...
    <section class="py-[40px] flex flex-col gap-[100px]">
        <div class="flex flex-col gap-[30px]">
            <h2 class="subTitle">내가 돈마고치를 시작한 이유</h2>
            <p>매일 아침, 나는 수많은 알림 소리 때문에 잠에서 깨어난다. 바로 은행 앱에서 울리는 수십 건의 입금 메시지이다.<br/><br/>

            내 아침 루틴 중 가장 먼저 하는 일은 은행 잔고 확인이다. <br/>보통 적으면 250만 원부터 많게는 1000만 원 이상까지 매일 새벽 입금되고 있다.<br/>
            이제는 놀랍지도 않다. 벌써 이런 생활만 5년 째이기 때문이다.<br/><br/>

            오늘 아침, 문득 여행을 가고 싶다는 생각이 들었다. <br/>"언제 갈까. 월요일, 수요일?" 32초 간 심각하게 고민한 끝에 수요일로 결정했다.<br/><br/>

            평일이어도 상관없다. 나는 시간에 구애받는 직장인이 아니기 때문이다. <br/>돈에도 구애받지 않는다. 방금 원하는 숙소를 아무 고민과 감흥 없이 예약했다.</p>
            ...
            <p>
                ...
                하지만 나는 전혀 신경 쓰지 않는다. 
                그 이유는 늘 한결같다. 내 인생은 너무나 행복하고 정말로 완벽하다.
            </p>
        </div>
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            ...
            <p>난 흙수저 집안에서 태어났다. 이 글을 읽는 당신보다 내가 훨씬 더 가난한 집안에서 자랐을 것이다.
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            ...
            <p>그렇게 사업에 대한 꿈을 가지고 서울 신림동에 올라왔다. 내 나이는 20살이었다. 부모님은 이 사실을 알지 못했다.
            ...
            <p>
                ...
                글쓰기, 심리학, 마케팅, 영업 등 인생에서 가장 열심히 공부한 순간이었다.
                나는 공부를 하며 점점 확신이 생기기 시작했다.
            </p>
            <p>
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            ...
            <p>곧바로 두 번째 사업을 시작했다. 새로운 아이템은 SNS로 심리 상담을 해주는 것이었다.
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            ...
            <p>그렇게 나는 마지막 사업을 준비했다. 한 번도 해보지 않은 디자인이었다. 심지어 내가 학생 때 가장 싫어하던 수업은 미술이었다. 나는 지푸라기라도 잡는 심정으로 시작했다. 
            ...
            <p>
                디자인 사업을 시작한 지 3개월 차, 월 매출 2200만 원을 달성하였다.나는 더 이상 돈이 부족하지 않았다. 나의 인생은 바뀌었다.
            </p>
    </section>
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            ...
            <p>
                ...
                ​
                그래서 난 지난 2년간 운영했던 다마고치를 폐지하기로 결정했다. 그리고 새로운 강의를 기획했다. 이름하여 '돈파르타'다. 가장 먼저 3주간 주말(오프라인), 평일(온라인)을 가리지 않고 사업에 대한 모든 지식을 가르친다. 주말에는 오프라인에서 현강을 진행한다. 평일에는 온라인을 통해 추가 강의를 강제로 수강한다.
            </p>
            ...
            <p>이후 12주 동안 사업을 12단계로 나누어 매주 한 단계 씩 강제로 진전되게 만든다. 이 과정에서 기존 다마고치에서 성과가 난 수강생이 밀착 피드백을 진행한다. 제대로 따라오지 못하거나, 뒤처지는 사람은 더 가까이 붙어서 관리한다. 이렇게 수업 3주, 강제 실행 12주가 지나면 목표인 월 매출 1000만원, 아무리 못해도 500만원은 나오는 사업체를 가질 수 있도록 설계했다.</p>
            <h3 class="point">돈마고치 커리큘럼</h3>
            <img src="">
            <p>
...
​
    ...
    <section class="py-[40px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            <h2 class="subTitle">99명에게 희망을 팔고 1명에게 성공을 파는 온라인 강의에 대하여</h2>
            <p>
...
​
            ...
            <p>
                ...
                ​
                그래서 나는 이번에 다마고치를 폐기하기로 결심했다. 그리고 완전히 새로운 사업 실행 프로그램인 돈파르타를 만들었다. 3주간의 강제 학습, 12주간의 매출 강제 발생 커리큘럼. 그리고 16주가 끝날 때, 매출이 발생하지 않았다면 무조건 환불해주는 프로그램이다.
                ​
                이제는 ‘배우는’ 강의가 아니라, ‘시작하게 만드는’ 강의가 필요하다. 돈마고치는 그걸 가능하게 할 유일한 프로그램이 될 것이다. 끝.
            </p>
    </section>
    <!-- 강의 신청을 원하는 분들은 아래 버튼을 클릭해 주세요 -->
    <section class="full bg-[#111] text-white py-[80px] flex flex-col gap-[80px]">
        <div class="flex flex-col gap-[80px]">
            <h2 class="subTitle">강의 신청을 원하는 분들은 아래 버튼을 클릭해 주세요</h2>
            <div class="youtube-item">
                    <div class="youtube-embed">
                        <iframe src="https://www.youtube.com/embed/LAaQEG96IIE"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            ...
            <h2 class="px-24 py-3 h2 button">수강 대기 신청하기</h2>
    </section>
</main>
